...
attribute shreg_extract : string;
    ...
    signal i_19_reg_534 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_439_fu_2110_p4 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    am_submul_16s_16s_24_4_1_U1130 : component TOP_am_submul_16s_16s_24_4_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    i_19_reg_534_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
                i_19_reg_534 <= add_ln371_reg_3349;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state5)) then 
                i_19_reg_534 <= ap_const_lv3_0;
            end if; 
        end if;
    end process;
    ...
    add_ln371_fu_2104_p2 <= std_logic_vector(unsigned(i_19_reg_534) + unsigned(ap_const_lv3_1));
    ...
    icmp_ln371_fu_2098_p2 <= "1" when (i_19_reg_534 = ap_const_lv3_4) else "0";
    icmp_ln382_fu_2120_p2 <= "1" when (tmp_439_fu_2110_p4 = ap_const_lv2_0) else "0";
    ...
    tmp_439_fu_2110_p4 <= i_19_reg_534(2 downto 1);
    tmp_cast_fu_1942_p3 <= (trunc_ln712_reg_3051 & ap_const_lv3_0);
    tmp_fu_1197_p3 <= j_fu_98(3 downto 3);
    trunc_ln371_fu_2093_p1 <= i_19_reg_534(2 - 1 downto 0);
