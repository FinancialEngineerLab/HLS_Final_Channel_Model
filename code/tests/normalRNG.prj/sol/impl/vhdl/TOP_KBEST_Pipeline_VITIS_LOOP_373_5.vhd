...
entity TOP_KBEST_Pipeline_VITIS_LOOP_373_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    i_19 : IN STD_LOGIC_VECTOR (1 downto 0);
    dist_V_out : OUT STD_LOGIC_VECTOR (15 downto 0);
    dist_V_out_ap_vld : OUT STD_LOGIC );
end;


architecture behav of TOP_KBEST_Pipeline_VITIS_LOOP_373_5 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln373_fu_381_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln374_fu_456_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln374_reg_697 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln373_fu_462_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln352_cast_fu_350_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_36_fu_401_p10 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_37_fu_415_p10 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_38_fu_429_p10 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_39_fu_443_p6 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    mux_864_32_1_1_U975 : component TOP_mux_864_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_864_32_1_1_U976 : component TOP_mux_864_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din7 => p_reload167,
        din8 => j_fu_116,
        dout => tmp_36_fu_401_p10);

    mux_864_32_1_1_U977 : component TOP_mux_864_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din7 => p_reload160,
        din8 => j_fu_116,
        dout => tmp_37_fu_415_p10);

    mux_864_32_1_1_U978 : component TOP_mux_864_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din7 => p_reload153,
        din8 => j_fu_116,
        dout => tmp_38_fu_429_p10);

    mux_42_32_1_1_U979 : component TOP_mux_42_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    port map (
        ...
        din1 => tmp_36_fu_401_p10,
        din2 => tmp_37_fu_415_p10,
        din3 => tmp_38_fu_429_p10,
        din4 => i_19,
        dout => tmp_39_fu_443_p6);
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    j_fu_116 <= zext_ln352_cast_fu_350_p1;
                elsif (((icmp_ln373_fu_381_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    j_fu_116 <= add_ln373_fu_462_p2;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln373_fu_381_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln374_reg_697 <= icmp_ln374_fu_456_p2;
            end if;
        end if;
    end process;
    ...
    R_address0 <= zext_ln712_1_fu_376_p1(6 - 1 downto 0);

    R_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    add_ln373_fu_462_p2 <= std_logic_vector(unsigned(j_fu_116) + unsigned(ap_const_lv64_1));
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln373_fu_381_p2)
    begin
        if (((icmp_ln373_fu_381_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    dist_V_1_fu_476_p2 <= std_logic_vector(unsigned(R_q0) + unsigned(dist_V_fu_112));
    dist_V_2_fu_482_p2 <= std_logic_vector(unsigned(dist_V_fu_112) - unsigned(R_q0));
    dist_V_3_fu_488_p3 <= 
        dist_V_1_fu_476_p2 when (icmp_ln374_reg_697(0) = '1') else 
        dist_V_2_fu_482_p2;
    dist_V_out <= dist_V_fu_112;

    dist_V_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln373_fu_381_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln373_fu_381_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln373_fu_381_p2 <= "1" when (j_fu_116 = ap_const_lv64_8) else "0";
    icmp_ln374_fu_456_p2 <= "1" when (tmp_39_fu_443_p6 = ap_const_lv32_1) else "0";
    trunc_ln712_fu_367_p1 <= j_fu_116(6 - 1 downto 0);
    zext_ln352_cast_fu_350_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln352),64));
