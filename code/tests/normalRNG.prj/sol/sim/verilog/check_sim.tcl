...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.TOP.autotvin_xxr.dat"
         "c.TOP.autotvin_xxi.dat"
         "c.TOP.autotvin_out_r.dat"
         "c.TOP.autotvin_Y_0.dat"
         "c.TOP.autotvin_Y_1.dat"
         "c.TOP.autotvin_Y_2.dat"
         "c.TOP.autotvin_Y_3.dat"
         "c.TOP.autotvin_Y_4.dat"
         "c.TOP.autotvin_Y_5.dat"
         "c.TOP.autotvin_Y_6.dat"
         "c.TOP.autotvin_Y_7.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.TOP.autotvout_xxr.dat"
         "rtl.TOP.autotvout_xxi.dat"
         "rtl.TOP.autotvout_out_r.dat"
         "rtl.TOP.autotvout_Y_0.dat"
         "rtl.TOP.autotvout_Y_1.dat"
         "rtl.TOP.autotvout_Y_2.dat"
         "rtl.TOP.autotvout_Y_3.dat"
         "rtl.TOP.autotvout_Y_4.dat"
         "rtl.TOP.autotvout_Y_5.dat"
         "rtl.TOP.autotvout_Y_6.dat"
         "rtl.TOP.autotvout_Y_7.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
