set moduleName Rayleigh_Pipeline_VITIS_LOOP_69_6
set isTopModule 0
...
set C_modelName {Rayleigh_Pipeline_VITIS_LOOP_69_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ H_rvd double 64 regular {array 64 { 1 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dadd_64ns_64ns_64_1_full_dsp_1_U64", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dadd_64ns_64ns_64_1_full_dsp_1_U65", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dmul_64ns_64ns_64_1_max_dsp_1_U66", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dmul_64ns_64ns_64_1_max_dsp_1_U67", "Parent" : "0"},
...
set Spec2ImplPortList { 
	H_rvd { ap_memory {  { H_rvd_address0 mem_address 1 6 }  { H_rvd_ce0 mem_ce 1 1 }  { H_rvd_q0 in_data 0 64 }  { H_rvd_address1 MemPortADDR2 1 6 }  { H_rvd_ce1 MemPortCE2 1 1 }  { H_rvd_q1 in_data 0 64 } } }
